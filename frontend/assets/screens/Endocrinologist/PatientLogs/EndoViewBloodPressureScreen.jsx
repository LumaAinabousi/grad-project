...
const EndoViewBloodPressureScreen = ({ route }) => {
  ...
  useEffect(() => {
    async function fetchBPData() {
      try {
        ...
        const API_URL_BP = `http://yourpublicIP:8000/patients/${patientID}/logs/bp-log/`;
...
export default EndoViewBloodPressureScreen;
